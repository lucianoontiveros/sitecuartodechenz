  ...
  return (
    <div className="sonidos-container">
      <ScrollAnimation effect="fade-up" delay={100}>
        ...
        <p className="page-subtitle">Explora nuestra colección de sonidos ambientales</p>
      </ScrollAnimation>
      ...
      <ScrollAnimation effect="fade-up" delay={300}>
        <div className="sonidos-cta">
          ...
          <p>Sugiere nuevos sonidos y podríamos agregarlos a la colección a través de los puntos del canal</p>
        </div>
      </ScrollAnimation>
    </div>
  );
